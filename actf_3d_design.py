"""ACTF (Android Cyborg Transformers) 3D conceptual CAD generator.

Free CAD stack:
- Python CAD kernel: CadQuery (Apache-2.0)
- Geometry engine: OpenCascade (via cadquery-ocp)

This script generates conceptual modules derived from README.md:
1) Exoskeleton shell (외골격)
2) Endoskeleton core (내골격)
3) Full-body assembly concept (전신)

Outputs STEP and STL files in ./output.
"""
